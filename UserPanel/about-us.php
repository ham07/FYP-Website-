...
include "includes/header-footer.php";
 ?>
        		...
        		<div class="about_inner row">
        			<div class="col-lg-6">
        				<div class="about_left_text">
        					...
        					<h5>We are here to give you a best experience</h5>
        					<p>We are providing you with the best services in town.Today workplace is not about a physical place but establishing community.
                    Synergy and creativity.Our design are specially designed for Enterpreneurs
                    User can order furniture products by sitting at home user can post furniture ads to sale and purchase products
                  User can book a carpenter online through our services in cheapest Price.User can find furniture stores .This website is not only for user end it is also for furniture retailers
                they can showcase their products to boost their business
              Where creativity and inspiration is cultialted</p>
        ...
        <section class="projects_area">
          ...
          <div class="hover">
            <h4>Cusion Sofa</h4>
            <p>A luxury to have it you can place it anywhere you want it provide you with comfort.</p>
          </div>
        </div>
        <div class="projects_item wd_18">
          ...
          <div class="hover">
            <h4>Side Table</h4>
            <p>You can place it by your side put anything on it to feel comfort .</p>
          </div>
        </div>
        ...
        <div class="projects_item wd_18">
          ...
          <div class="hover">
            <h4>Living Room Desk</h4>
            <p> It is uniquely modern in style, and has texture in colour which made it long lasting and beautifull.</p>
          </div>
        </div>
          </div>
        </section>
